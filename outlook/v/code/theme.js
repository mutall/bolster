...
export class theme extends outlook.panel {
    ...
    scroll_page(dir) {
        ...
        let target_tr;
        //
        if (this.inview(selected_tr)) {
            //
            //Get the tr to be scrolled into view, guided by the client height.
            target_tr = this.get_target_tr(selected_tr, dir, false);
        }
        else {
            //
            ...
            //
            //
            target_tr = this.get_target_tr(selected_tr, dir, true);
        }
        //
        if (target_tr === null) {
            //
    ...
    get_page_tr(selected_tr, dir) {
        ...
        const tbody = selected_tr.parentElement;
        //
    ...
    get_target_tr(selected_tr, dir, request) {
        //
        //Get the current table's body
        const tbody = selected_tr.parentElement;
        //
